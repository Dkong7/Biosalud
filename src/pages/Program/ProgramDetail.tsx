          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-16">
             <div className="lg:col-span-2">
                <div className="mb-10 relative">
                   ...
                   <p className="font-cambria text-2xl text-bio-verde font-bold italic leading-relaxed">"{data.intro}"</p>
                </div>
                ...
                <div className="mt-12 p-8 bg-[#f8f9f3] rounded-sm border-l-4 border-bio-verde">
                   ...
                   <p className="text-gray-600 italic">{t('program.target_desc')}</p>
                </div>
             </div>
             <div className="lg:col-span-1">
                <div className="bg-white p-8 rounded-sm shadow-xl border border-gray-100 sticky top-24">
                   <h3 className="font-eras text-xl font-bold text-gray-800 mb-6 pb-4 border-b border-gray-100">{t('program.methodology_title')}</h3>
